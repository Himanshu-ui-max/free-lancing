...
function footer() {
  return (
    ...
    <div className='infofooter'>
      ...
      <div className='para'>Sai Super Pack is a prominent manufacturer and supplier of a broad array of Packaging Material like Air Bubble Pouches, PP Bins / Boxes, EPE Pouches, Stretch Film Rolls and more.</div>
    </div>
