...
const CompanyProfile = () => {
  return (
    ...
    <div className='companyProfile'style={{overflow:"hidden"}}>
      ...
      <div className= 'd-flex justify-content-center PrFULL'>
        <div className=" d-flex justify-content-center PrIMG" style={{width:'60%'}}>
        <img src="https://www.stiplindia.com/wp-content/uploads/2023/11/paper-machines-1-1024x589.jpg" alt="Paris"/>
        </div>
        <div className="PrTEXT" style={{width: "60%", marginRight:'5%'}}>
...
<path d="M21 27.3333C24.4978 27.3333 27.3333 24.4978 27.3333 21C27.3333 17.5022 24.4978 14.6667 21 14.6667C17.5022 14.6667 14.6666 17.5022 14.6666 21C14.6666 24.4978 17.5022 27.3333 21 27.3333Z" stroke="black" stroke-width="4" stroke-linecap="round" stroke-linejoin="round"/>
       ...
       <div id="CompADD">
            <p4>Corporate Office</p4>
            <div id="pIN" >
           <p5>J-30, Site-C, Surajpur Industrial Area, Greater Noida - 201306, Uttar Pradesh, India
            </p5></div>
           </div>
           </div>
      </div>
