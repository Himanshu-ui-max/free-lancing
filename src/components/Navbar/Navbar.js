...
const Navbar = () => {
  ...
  <div className="d-flex justify-content-between container-fluid" style={{zIndex:'1',display:'flex',justifyContent:'space-between',alignItems : 'center',backgroundColor : "white"}}>
    ...
    <button className="navbar-toggler" ref={anyRef} type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
